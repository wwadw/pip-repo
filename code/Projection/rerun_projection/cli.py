...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--bag", dest="bag_file", required=True, help="Input rosbag path")
    parser.add_argument("--yaml", dest="yaml_path", default="", help="YAML file with camera parameters")
    parser.add_argument("--image-topic", dest="image_topic", help="Semantic image topic")
